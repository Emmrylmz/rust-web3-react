...
pub async fn voting_cli() {
    ...
    match cmd.as_str() {
        ...
        "add_proposal" => interact.add_proposal().await,
...
impl ContractInteract {
    pub async fn new() -> Self {
        ...
        interactor.set_current_dir_from_workspace("voting");
    ...
    pub async fn get_results(&mut self) {
